package com.python.wanandroid.view.wheelview;
...
public class WheelView extends View {
     ...
     */
    private static final int SCROLLING_DURATION = 10;
     ...
     * 顶部和底部的阴影颜色
     */
    private static final int[] SHADOWS_COLORS = new int[]{0x99FFFFFF, 0x00FFFFFF, 0x99FFFFFF};
    ...
    private static final int TEXT_SIZE_NORMAL = 43;
    ...
    private void initResourcesIfNecessary() {
        ...
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(getResources().getDimension(R.dimen.sp_14));
        }
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setTextSize(getResources().getDimension(R.dimen.sp_16));
            valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
        }

        //选中的条目背景
        if (centerDrawable == null) {
            //            centerDrawable = getContext().getResources().getDrawable(R.drawable.alarm_time_select_bg);
    ...
    private void drawShadows(Canvas canvas) {
        ...
        bottomShadow.setBounds(0, getHeight() - getHeight(), getWidth(), getHeight());
    ...
    private void drawItems(Canvas canvas) {
        ...
        //设置画笔颜色
        itemsPaint.setColor(Color.parseColor("#b2b2b2"));
        //将当前 View 状态属性值 转为整型集合, 赋值给 普通条目布局的绘制属性
    ...
    private SimpleOnGestureListener gestureListener = new SimpleOnGestureListener() {
         ...
         * (non-Javadoc)
         * @see SimpleOnGestureListener#onScroll(MotionEvent, MotionEvent, float, float)
         */
         ...
         *
         * (non-Javadoc)
         * @see SimpleOnGestureListener#onFling(MotionEvent, MotionEvent, float, float)
         */
